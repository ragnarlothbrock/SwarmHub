...
// Skip: Component uses CitationDisplay which needs proper mocking
describe.skip('ChatPage', () => {
  ...
  it('renders chat interface', () => {
    render(<ChatPage />);
    expect(
      screen.getByPlaceholderText('Type your question here to get started...')
    ).toBeInTheDocument();
  ...
  it('handles error state', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(
          'I apologize, but I encountered an error: Failed to start stream. Please try again.'
        )
      ).toBeInTheDocument();
    });
