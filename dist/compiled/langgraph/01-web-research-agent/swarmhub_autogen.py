# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: 01-web-research-agent
...
search = autogen.ConversableAgent(
    name="search",
    system_message="Extracted automatically via SwarmHub static AST source-slicing. You operate code blob reference: blobs/search.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

synthesize = autogen.ConversableAgent(
    name="synthesize",
    system_message="Extracted automatically via SwarmHub static AST source-slicing. You operate code blob reference: blobs/synthesize.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
