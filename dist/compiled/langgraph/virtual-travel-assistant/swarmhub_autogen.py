# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: virtual-travel-assistant
...
call_tools_llm = autogen.ConversableAgent(
    name="call_tools_llm",
    system_message="Extracted automatically via SwarmHub static AST source-slicing. You operate code blob reference: blobs/call_tools_llm.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

invoke_tools = autogen.ConversableAgent(
    name="invoke_tools",
    system_message="Extracted automatically via SwarmHub static AST source-slicing. You operate code blob reference: blobs/invoke_tools.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

email_sender = autogen.ConversableAgent(
    name="email_sender",
    system_message="Extracted automatically via SwarmHub static AST source-slicing. You operate code blob reference: blobs/email_sender.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
groupchat = autogen.GroupChat(
    agents=[call_tools_llm, invoke_tools, email_sender],
    messages=[],
    max_round=50
)
