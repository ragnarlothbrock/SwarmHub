# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: langgraph-chatbot-simulation-evaluation
...
#   "kind": "UniversalAgent",
#   "name": "langgraph-chatbot-simulation-evaluation",
#   "runtime": {
...
user = autogen.ConversableAgent(
    name="user",
    system_message="Extracted automatically via SwarmHub static AST source-slicing. You operate code blob reference: blobs/user.py.",
...
assistant = autogen.ConversableAgent(
    name="assistant",
    system_message="Extracted automatically via SwarmHub static AST source-slicing. You operate code blob reference: blobs/assistant.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
