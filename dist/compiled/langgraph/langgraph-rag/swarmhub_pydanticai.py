...
grade_documents_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted automatically via SwarmHub static AST source-slicing. Node context: grade_documents. Authorized MCP Interfaces: []",
)
...
transform_query_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted automatically via SwarmHub static AST source-slicing. Node context: transform_query. Authorized MCP Interfaces: []",
)
...
web_search_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted automatically via SwarmHub static AST source-slicing. Node context: web_search. Authorized MCP Interfaces: []",
)
...
web_search_node_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted automatically via SwarmHub static AST source-slicing. Node context: web_search_node. Authorized MCP Interfaces: []",
)
...
rewrite_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted automatically via SwarmHub static AST source-slicing. Node context: rewrite. Authorized MCP Interfaces: []",
)
...
llm_fallback_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted automatically via SwarmHub static AST source-slicing. Node context: llm_fallback. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        ...
        "grade_documents": grade_documents_agent,
        "generate": generate_agent,
        "transform_query": transform_query_agent,
        "retrieve": retrieve_agent,
        "grade_documents": grade_documents_agent,
        "generate": generate_agent,
        "transform_query": transform_query_agent,
        ...
        "generate": generate_agent,
        "transform_query": transform_query_agent,
        "web_search_node": web_search_node_agent,
        "web_search": web_search_agent,
        "retrieve": retrieve_agent,
        "grade_documents": grade_documents_agent,
        "generate": generate_agent,
        ...
        "grade_documents": grade_documents_agent,
        "generate": generate_agent,
        "llm_fallback": llm_fallback_agent,
    }
    NODES_PIPELINE_MAP = {
        "retrieve": importlib.import_module("blobs.retrieve").run,
        "grade_documents": importlib.import_module("blobs.grade_documents").run,
        "generate": importlib.import_module("blobs.generate").run,
        "transform_query": importlib.import_module("blobs.transform_query").run,
        "retrieve": importlib.import_module("blobs.retrieve").run,
        "grade_documents": importlib.import_module("blobs.grade_documents").run,
        "generate": importlib.import_module("blobs.generate").run,
        "transform_query": importlib.import_module("blobs.transform_query").run,
        "web_search": importlib.import_module("blobs.web_search").run,
        "retrieve": importlib.import_module("blobs.retrieve").run,
        "grade_documents": importlib.import_module("blobs.grade_documents").run,
        "generate": importlib.import_module("blobs.generate").run,
        "transform_query": importlib.import_module("blobs.transform_query").run,
        ...
        "generate": importlib.import_module("blobs.generate").run,
        "transform_query": importlib.import_module("blobs.transform_query").run,
        "web_search_node": importlib.import_module("blobs.web_search_node").run,
        "web_search": importlib.import_module("blobs.web_search").run,
        "retrieve": importlib.import_module("blobs.retrieve").run,
        "grade_documents": importlib.import_module("blobs.grade_documents").run,
        "generate": importlib.import_module("blobs.generate").run,
        ...
        "retrieve": importlib.import_module("blobs.retrieve").run,
        "rewrite": importlib.import_module("blobs.rewrite").run,
        "generate": importlib.import_module("blobs.generate").run,
        "web_search": importlib.import_module("blobs.web_search").run,
        "retrieve": importlib.import_module("blobs.retrieve").run,
        "grade_documents": importlib.import_module("blobs.grade_documents").run,
        "generate": importlib.import_module("blobs.generate").run,
        "llm_fallback": importlib.import_module("blobs.llm_fallback").run,
    }
