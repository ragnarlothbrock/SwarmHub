# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: langgraph-code-assistant
...
check_code = autogen.ConversableAgent(
    name="check_code",
    system_message="Extracted automatically via SwarmHub static AST source-slicing. You operate code blob reference: blobs/check_code.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
