...
check_code_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted automatically via SwarmHub static AST source-slicing. Node context: check_code. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        ...
        "check_code": check_code_agent,
    }
    NODES_PIPELINE_MAP = {
        "generate": importlib.import_module("blobs.generate").run,
        "check_code": importlib.import_module("blobs.check_code").run,
    }
