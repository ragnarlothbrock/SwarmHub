# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: 20-multi-agent-debate
...
Dr. Alex Chen = autogen.ConversableAgent(
    name="Dr. Alex Chen",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/Dr. Alex Chen.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

Prof. Sarah Martinez = autogen.ConversableAgent(
    name="Prof. Sarah Martinez",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/Prof. Sarah Martinez.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
groupchat = autogen.GroupChat(
    agents=[Dr. Alex Chen, Prof. Sarah Martinez],
    messages=[],
    max_round=50
)
