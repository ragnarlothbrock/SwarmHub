# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SWARM: 20-multi-agent-debate
...
Dr. Alex Chen_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted from legacy conversational script via AST source-slicing. Node context: Dr. Alex Chen. Authorized MCP Interfaces: []",
)

Prof. Sarah Martinez_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted from legacy conversational script via AST source-slicing. Node context: Prof. Sarah Martinez. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        "Dr. Alex Chen": Dr. Alex Chen_agent,
        "Prof. Sarah Martinez": Prof. Sarah Martinez_agent,
    }
    NODES_PIPELINE_MAP = {
        "Dr. Alex Chen": importlib.import_module("blobs.Dr. Alex Chen").run,
        "Prof. Sarah Martinez": importlib.import_module("blobs.Prof. Sarah Martinez").run,
    }
