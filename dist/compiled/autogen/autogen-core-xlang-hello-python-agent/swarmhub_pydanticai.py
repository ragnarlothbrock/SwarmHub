...
UserProxy_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted from legacy conversational script via AST source-slicing. Node context: UserProxy. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        "UserProxy": UserProxy_agent,
    }
    NODES_PIPELINE_MAP = {
        "UserProxy": importlib.import_module("blobs.UserProxy").run,
    }
