...
teachable_agent_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted from legacy conversational script via AST source-slicing. Node context: teachable_agent. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        "teachable_agent": teachable_agent_agent,
    }
    NODES_PIPELINE_MAP = {
        "teachable_agent": importlib.import_module("blobs.teachable_agent").run,
    }
