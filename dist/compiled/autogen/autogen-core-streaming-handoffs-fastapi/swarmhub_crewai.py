# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SWARM: autogen-core-streaming-handoffs-fastapi
...
#   "kind": "UniversalAgent",
#   "name": "autogen-core-streaming-handoffs-fastapi",
#   "runtime": {
...
#   "topology": {
#     "type": "StateMachine",
#     "initial_node": "AIAgent",
#     "nodes": [
#       {
#         "id": "AIAgent",
#         "executor_type": "opaque_blob",
#         "executor_reference": "blobs/AIAgent.py",
#         "transitions": [
#           {
#             "on_condition": "GOTO_USERAGENT",
#             "target_node": "UserAgent"
#           }
#         ],
#         "tools": [],
#         "interfaces": []
...
#         "id": "UserAgent",
#         "executor_type": "opaque_blob",
#         "executor_reference": "blobs/UserAgent.py",
#         "transitions": [],
#         "tools": [],
#         "interfaces": []
#       }
...
AIAgent_agent = Agent(
    role="Aiagent",
    goal="Execute capabilities defined under the workspace node AIAgent",
...
UserAgent_agent = Agent(
    role="Useragent",
    goal="Execute capabilities defined under the workspace node UserAgent",
    backstory="You are a specialized automation layer unit extracted from a opaque_blob pipeline. Authorized MCP Interfaces: []",
    tools=[],
    verbose=True,
    allow_delegation=False
...
AIAgent_task = Task(
    description="Execute processing code logic anchored at: blobs/AIAgent.py. Authorized Connection Boundaries: []",
    expected_output="Successful completion state payload matching criteria for next sequence step.",
    agent=AIAgent_agent
)

UserAgent_task = Task(
    description="Execute processing code logic anchored at: blobs/UserAgent.py. Authorized Connection Boundaries: []",
    expected_output="Successful completion state payload matching criteria for next sequence step.",
    agent=UserAgent_agent
)

# 7. Assemble the Unified Crew Workspace Execution Order
crew = Crew(
    agents=[AIAgent_agent, UserAgent_agent],
    tasks=[AIAgent_task, UserAgent_task],
...
if __name__ == "__main__":
    ...
    NODES_CONFIG = {
        "AIAgent": {"import_path": "blobs.AIAgent", "interfaces": [], "inline_f": "_inline_AIAgent" if hasattr(sys.modules[__name__], "_inline_AIAgent") else None},
        "UserAgent": {"import_path": "blobs.UserAgent", "interfaces": [], "inline_f": "_inline_UserAgent" if hasattr(sys.modules[__name__], "_inline_UserAgent") else None},
    }
