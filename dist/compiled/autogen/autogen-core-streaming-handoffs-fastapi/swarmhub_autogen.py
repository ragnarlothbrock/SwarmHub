# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: autogen-core-streaming-handoffs-fastapi
...
AIAgent = autogen.ConversableAgent(
    name="AIAgent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/AIAgent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

UserAgent = autogen.ConversableAgent(
    name="UserAgent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/UserAgent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
