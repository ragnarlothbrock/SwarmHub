# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: autogen-agentchat-graphrag
...
search_assistant = autogen.ConversableAgent(
    name="search_assistant",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/search_assistant.py.",
