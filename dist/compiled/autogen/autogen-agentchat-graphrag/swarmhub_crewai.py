# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SWARM: autogen-agentchat-graphrag
...
#   "kind": "UniversalAgent",
#   "name": "autogen-agentchat-graphrag",
#   "runtime": {
...
#   "topology": {
#     "type": "StateMachine",
#     "initial_node": "search_assistant",
#     "nodes": [
#       {
#         "id": "search_assistant",
#         "executor_type": "opaque_blob",
#         "executor_reference": "blobs/search_assistant.py",
#         "transitions": [],
#         "tools": [],
#         "interfaces": []
#       }
...
search_assistant_agent = Agent(
    role="Search Assistant",
    goal="Execute capabilities defined under the workspace node search_assistant",
...
search_assistant_task = Task(
    description="Execute processing code logic anchored at: blobs/search_assistant.py. Authorized Connection Boundaries: []",
...
crew = Crew(
    agents=[search_assistant_agent],
    tasks=[search_assistant_task],
...
if __name__ == "__main__":
    ...
    NODES_CONFIG = {
        "search_assistant": {"import_path": "blobs.search_assistant", "interfaces": [], "inline_f": "_inline_search_assistant" if hasattr(sys.modules[__name__], "_inline_search_assistant") else None},
    }
