# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: 06-news-summarizer-agent
...
default_autogen_agent = autogen.ConversableAgent(
    name="default_autogen_agent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/default_autogen_agent.py.",
