...
default_autogen_agent_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted from legacy conversational script via AST source-slicing. Node context: default_autogen_agent. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        "default_autogen_agent": default_autogen_agent_agent,
    }
    NODES_PIPELINE_MAP = {
        "default_autogen_agent": importlib.import_module("blobs.default_autogen_agent").run,
    }
