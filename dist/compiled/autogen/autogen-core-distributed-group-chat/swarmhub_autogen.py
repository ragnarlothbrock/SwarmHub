# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: autogen-core-distributed-group-chat
...
BaseGroupChatAgent = autogen.ConversableAgent(
    name="BaseGroupChatAgent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/BaseGroupChatAgent.py.",
...
UIAgent = autogen.ConversableAgent(
    name="UIAgent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/UIAgent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
groupchat = autogen.GroupChat(
    agents=[BaseGroupChatAgent, GroupChatManager, UIAgent],
    messages=[],
    max_round=50
)
