# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: autogen-core-async-human-in-the-loop
...
SlowUserProxyAgent = autogen.ConversableAgent(
    name="SlowUserProxyAgent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/SlowUserProxyAgent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

SchedulingAssistantAgent = autogen.ConversableAgent(
    name="SchedulingAssistantAgent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/SchedulingAssistantAgent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
groupchat = autogen.GroupChat(
    agents=[SlowUserProxyAgent, SchedulingAssistantAgent],
    messages=[],
    max_round=50
)
