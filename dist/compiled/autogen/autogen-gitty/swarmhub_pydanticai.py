...
GittyAgent_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted from legacy conversational script via AST source-slicing. Node context: GittyAgent. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        "GittyAgent": GittyAgent_agent,
    }
    NODES_PIPELINE_MAP = {
        "GittyAgent": importlib.import_module("blobs.GittyAgent").run,
    }
