...
PlayerAgent_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted from legacy conversational script via AST source-slicing. Node context: PlayerAgent. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        "PlayerAgent": PlayerAgent_agent,
    }
    NODES_PIPELINE_MAP = {
        "PlayerAgent": importlib.import_module("blobs.PlayerAgent").run,
    }
