...
MyAgent_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted from legacy conversational script via AST source-slicing. Node context: MyAgent. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        "MyAgent": MyAgent_agent,
    }
    NODES_PIPELINE_MAP = {
        "MyAgent": importlib.import_module("blobs.MyAgent").run,
    }
