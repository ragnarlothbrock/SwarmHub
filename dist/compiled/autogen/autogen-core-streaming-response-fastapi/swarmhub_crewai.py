# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SWARM: autogen-core-streaming-response-fastapi
...
#   "kind": "UniversalAgent",
#   "name": "autogen-core-streaming-response-fastapi",
#   "runtime": {
...
#   "topology": {
#     "type": "StateMachine",
#     "initial_node": "MyAgent",
#     "nodes": [
#       {
#         "id": "MyAgent",
#         "executor_type": "opaque_blob",
#         "executor_reference": "blobs/MyAgent.py",
#         "transitions": [],
#         "tools": [],
#         "interfaces": []
#       }
...
MyAgent_agent = Agent(
    role="Myagent",
    goal="Execute capabilities defined under the workspace node MyAgent",
...
MyAgent_task = Task(
    description="Execute processing code logic anchored at: blobs/MyAgent.py. Authorized Connection Boundaries: []",
...
if __name__ == "__main__":
    ...
    NODES_CONFIG = {
        "MyAgent": {"import_path": "blobs.MyAgent", "interfaces": [], "inline_f": "_inline_MyAgent" if hasattr(sys.modules[__name__], "_inline_MyAgent") else None},
    }
