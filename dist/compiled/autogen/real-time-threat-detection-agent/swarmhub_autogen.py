# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: real-time-threat-detection-agent
...
text_analyst_agent = autogen.ConversableAgent(
    name="text_analyst_agent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/text_analyst_agent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

internet_agent = autogen.ConversableAgent(
    name="internet_agent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/internet_agent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

cmd_exec_agent = autogen.ConversableAgent(
    name="cmd_exec_agent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/cmd_exec_agent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

caldera_agent = autogen.ConversableAgent(
    name="caldera_agent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/caldera_agent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

task_coordinator_agent = autogen.ConversableAgent(
    name="task_coordinator_agent",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/task_coordinator_agent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
groupchat = autogen.GroupChat(
    agents=[text_analyst_agent, internet_agent, cmd_exec_agent, caldera_agent, task_coordinator_agent],
    messages=[],
    max_round=50
)
