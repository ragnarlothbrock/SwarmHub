# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: autogen-agentchat-fastapi
...
#   "kind": "UniversalAgent",
#   "name": "autogen-agentchat-fastapi",
#   "runtime": {
...
#         "id": "yoda",
#         "executor_type": "opaque_blob",
#         "executor_reference": "blobs/yoda.py",
#         "transitions": [
#           {
...
yoda = autogen.ConversableAgent(
    name="yoda",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/yoda.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
user = autogen.ConversableAgent(
    name="user",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/user.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
groupchat = autogen.GroupChat(
    agents=[assistant, yoda, user, assistant],
    messages=[],
    max_round=50
)
...
if __name__ == "__main__":
    ...
    NODES_CONFIG = {
        ...
        "yoda": {"import_path": "blobs.yoda", "interfaces": [], "inline_f": "_inline_yoda" if hasattr(sys.modules[__name__], "_inline_yoda") else None},
