...
ai_player_agent = Agent(
    "openai:gpt-4o-mini",
    system_prompt="Extracted from legacy conversational script via AST source-slicing. Node context: ai_player. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        "ai_player": ai_player_agent,
    }
    NODES_PIPELINE_MAP = {
        "ai_player": importlib.import_module("blobs.ai_player").run,
    }
