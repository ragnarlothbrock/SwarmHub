# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SWARM: autogen-agentchat-chess-game
...
#   "kind": "UniversalAgent",
#   "name": "autogen-agentchat-chess-game",
#   "runtime": {
...
#   "topology": {
#     "type": "StateMachine",
#     "initial_node": "ai_player",
#     "nodes": [
#       {
#         "id": "ai_player",
#         "executor_type": "opaque_blob",
#         "executor_reference": "blobs/ai_player.py",
#         "transitions": [],
#         "tools": [],
#         "interfaces": []
#       }
...
ai_player_agent = Agent(
    role="Ai Player",
    goal="Execute capabilities defined under the workspace node ai_player",
...
ai_player_task = Task(
    description="Execute processing code logic anchored at: blobs/ai_player.py. Authorized Connection Boundaries: []",
    expected_output="Successful completion state payload matching criteria for next sequence step.",
    agent=ai_player_agent
)

# 7. Assemble the Unified Crew Workspace Execution Order
crew = Crew(
    agents=[ai_player_agent],
    tasks=[ai_player_task],
...
if __name__ == "__main__":
    ...
    NODES_CONFIG = {
        "ai_player": {"import_path": "blobs.ai_player", "interfaces": [], "inline_f": "_inline_ai_player" if hasattr(sys.modules[__name__], "_inline_ai_player") else None},
    }
