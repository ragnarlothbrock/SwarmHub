# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: autogen-agentchat-chess-game
...
ai_player = autogen.ConversableAgent(
    name="ai_player",
    system_message="Extracted from legacy conversational script via AST source-slicing. You operate code blob reference: blobs/ai_player.py.",
