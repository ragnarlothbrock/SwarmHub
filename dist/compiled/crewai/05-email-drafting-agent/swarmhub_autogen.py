# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: 05-email-drafting-agent
...
analyze = autogen.ConversableAgent(
    name="analyze",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/analyze.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

write = autogen.ConversableAgent(
    name="write",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/write.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
