...
analyze_agent = Agent(
    ...
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: analyze. Authorized MCP Interfaces: []",
)

write_agent = Agent(
    "unknown_crew_imported:unknown_crew_imported",
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: write. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_PIPELINE_MAP = {
        ...
        "write": importlib.import_module("blobs.write").run,
    }
