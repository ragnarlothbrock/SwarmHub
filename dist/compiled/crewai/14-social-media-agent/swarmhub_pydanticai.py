...
strategy_agent = Agent(
    ...
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: strategy. Authorized MCP Interfaces: []",
)

writing_agent = Agent(
    "unknown_crew_imported:unknown_crew_imported",
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: writing. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_PIPELINE_MAP = {
        "strategy": importlib.import_module("blobs.strategy").run,
        "writing": importlib.import_module("blobs.writing").run,
    }
