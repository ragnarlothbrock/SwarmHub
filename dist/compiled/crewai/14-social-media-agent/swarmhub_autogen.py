# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: 14-social-media-agent
...
strategy = autogen.ConversableAgent(
    name="strategy",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/strategy.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

writing = autogen.ConversableAgent(
    name="writing",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/writing.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
