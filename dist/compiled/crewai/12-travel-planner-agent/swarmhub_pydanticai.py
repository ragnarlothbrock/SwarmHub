...
research_agent = Agent(
    ...
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: research. Authorized MCP Interfaces: []",
)

planning_agent = Agent(
    "unknown_crew_imported:unknown_crew_imported",
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: planning. Authorized MCP Interfaces: []",
)

budget_agent = Agent(
    "unknown_crew_imported:unknown_crew_imported",
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: budget. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_PIPELINE_MAP = {
        "research": importlib.import_module("blobs.research").run,
        "planning": importlib.import_module("blobs.planning").run,
        "budget": importlib.import_module("blobs.budget").run,
    }
