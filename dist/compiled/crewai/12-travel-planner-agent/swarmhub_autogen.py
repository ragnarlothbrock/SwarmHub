# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: 12-travel-planner-agent
...
research = autogen.ConversableAgent(
    name="research",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/research.py.",
...
planning = autogen.ConversableAgent(
    name="planning",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/planning.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

budget = autogen.ConversableAgent(
    name="budget",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/budget.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
groupchat = autogen.GroupChat(
    agents=[research, planning, budget],
    messages=[],
    max_round=50
)
