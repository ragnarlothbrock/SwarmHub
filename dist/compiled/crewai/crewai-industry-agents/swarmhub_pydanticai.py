# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SWARM: crewai-industry-agents
...
biomed_agent_agent = Agent(
    ...
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: biomed_agent. Authorized MCP Interfaces: []",
)

healthcare_agent_agent = Agent(
    "unknown_crew_imported:unknown_crew_imported",
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: healthcare_agent. Authorized MCP Interfaces: []",
)

financial_agent_agent = Agent(
    "unknown_crew_imported:unknown_crew_imported",
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: financial_agent. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_REGISTRY = {
        "biomed_agent": biomed_agent_agent,
        "healthcare_agent": healthcare_agent_agent,
        "financial_agent": financial_agent_agent,
    }
    NODES_PIPELINE_MAP = {
        "biomed_agent": importlib.import_module("blobs.biomed_agent").run,
        "healthcare_agent": importlib.import_module("blobs.healthcare_agent").run,
        "financial_agent": importlib.import_module("blobs.financial_agent").run,
    }
