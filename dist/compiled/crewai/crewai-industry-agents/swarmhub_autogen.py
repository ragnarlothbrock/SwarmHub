# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: crewai-industry-agents
...
biomed_agent = autogen.ConversableAgent(
    name="biomed_agent",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/biomed_agent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

healthcare_agent = autogen.ConversableAgent(
    name="healthcare_agent",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/healthcare_agent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
financial_agent = autogen.ConversableAgent(
    ...
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/financial_agent.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
...
groupchat = autogen.GroupChat(
    agents=[biomed_agent, healthcare_agent, financial_agent],
    messages=[],
    max_round=50
)
