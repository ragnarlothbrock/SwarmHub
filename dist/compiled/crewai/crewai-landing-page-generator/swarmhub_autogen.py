# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: crewai-landing-page-generator
...
task = autogen.ConversableAgent(
    name="task",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/task.py.",
