...
unknown_agent = Agent(
    ...
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: unknown. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_PIPELINE_MAP = {
        "unknown": importlib.import_module("blobs.unknown").run,
    }
