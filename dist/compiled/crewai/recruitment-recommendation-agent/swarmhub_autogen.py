# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: recruitment-recommendation-agent
...
unknown = autogen.ConversableAgent(
    name="unknown",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/unknown.py.",
