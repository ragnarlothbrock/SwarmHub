# ==========================================================================
# GENERATED AUTOMATICALLY BY SWARMHUB FOR AGENT SYSTEM: 18-job-application-agent
...
analyst = autogen.ConversableAgent(
    name="analyst",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/analyst.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)

application = autogen.ConversableAgent(
    name="application",
    system_message="Extracted sequentially from legacy CrewAI manifest. You operate code blob reference: blobs/application.py.",
    llm_config=llm_config,
    human_input_mode="NEVER"
)
