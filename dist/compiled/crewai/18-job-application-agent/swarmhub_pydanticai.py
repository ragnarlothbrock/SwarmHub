...
analyst_agent = Agent(
    ...
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: analyst. Authorized MCP Interfaces: []",
)

application_agent = Agent(
    "unknown_crew_imported:unknown_crew_imported",
    system_prompt="Extracted sequentially from legacy CrewAI manifest. Node context: application. Authorized MCP Interfaces: []",
)
...
if __name__ == "__main__":
    ...
    NODES_PIPELINE_MAP = {
        "analyst": importlib.import_module("blobs.analyst").run,
        "application": importlib.import_module("blobs.application").run,
    }
